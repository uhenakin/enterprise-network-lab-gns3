# apr/19/2026 04:42:40 by RouterOS 6.49.19
# software id = 
#
#
#
...
/ip address
add address=10.70.70.3/29 interface=ether1 network=10.70.70.0
add address=192.168.2.1/24 interface=BR-Local network=192.168.2.0
/ip dhcp-client
